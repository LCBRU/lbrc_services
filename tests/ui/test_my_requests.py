...
from tests import lbrc_services_get, get_test_task, get_test_user, get_test_owned_task, get_test_service
...
def test__my_jobs__pages(client, faker, jobs, loggedin_user):
    my_jobs = [get_test_owned_task(faker, loggedin_user, requestor=loggedin_user) for _ in range(jobs)]

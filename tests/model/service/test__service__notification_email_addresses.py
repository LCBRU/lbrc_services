def test__notification_email_addresses__one_owner_no_generic(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u], generic_recipients='')
...
def test__notification_email_addresses__two_owners_no_generic(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u, u2], generic_recipients='')
...
def test__notification_email_addresses__one_generic(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u], generic_recipients='test@example.com')
...
def test__notification_email_addresses__two_generic(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u], generic_recipients='test@example.com,hello@internet.com')
...
def test__notification_email_addresses__generic_mixed_delimiter(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u], generic_recipients='test@example.com;hello@internet.com,email@email.com posh.silk.com')

def test__suppress_owner_email__true(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u], generic_recipients='test@example.com', suppress_owner_email=True)
...
def test__suppress_owner_email__false(client, faker):
    ...
    s = faker.service().get_in_db(owners=[u], generic_recipients='test@example.com', suppress_owner_email=False)
